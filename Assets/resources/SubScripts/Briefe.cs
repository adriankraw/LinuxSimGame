...
public class Briefe : MonoBehaviour
{
    private string[][] brief1 = {
        new string[] {
            @"Herzlichen Glückwunsch! Du hast deinen ersten Schritt gemacht.",
            @"In den kommenden Level werden dir immer weniger Erklärungen angezeigt",
            @"",
            @"Vergiss deine gelernten Befehle nicht! Oder nutz 'man', das geht auch."
        },
        new string[] {
            @"\tLieber u...-.-r",
